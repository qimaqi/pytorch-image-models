...
./distributed_train.sh 2 --data-dir /usr/bmicnas02/data-biwi-01/bmicdatasets-originals/Originals/ILSVRC2012_imagenet/imagenet --model hiera_inception_former_tiny_w0 --sched cosine --epochs 150 --warmup-epochs 5 --lr 1e-5 --batch-size 512 --amp -j 2 --num-classes 1000 --amp-dtype bfloat16 --opt adamw
